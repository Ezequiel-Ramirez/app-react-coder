                ...
                <CardColumns>
                    <Card>
                        <Card.Body>
                            ...
                            <ItemCount stock={item.stock} cantidad={cantidad} addItem={addItem} initial={item.stock >= 1 ? 1:0} onAdd={onAdd}/>
                            <LinkContainer to="/cart"><Button onClick={addItem}>Terminar mi Compra</Button></LinkContainer>
